...
public class DiagnosisDecisionAlgorithm {
    ...
    public HashMap<String,Float> getScoredDiagnosis(String[] inputSymptoms) throws SQLException, ClassNotFoundException {
        SQLiteJDBC sqliteJDBC = new SQLiteJDBC();
        Integer[] inputSymptomIds = sqliteJDBC.getSymptomIdsFromNames(inputSymptoms);
        ...
        ArrayList<Integer> filteredDiagnosisList = sqliteJDBC.getFilteredDiagnosisList(inputSymptomIds);
        ...
        for(int i = 0; i < filteredDiagnosisList.size(); i++)
        {
            ...
            Set<Integer> inputSymptomSet = new HashSet<Integer>(Arrays.asList(inputSymptomIds));
